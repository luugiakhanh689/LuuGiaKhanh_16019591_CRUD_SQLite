...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_TENLop="tel" ;

    private final static String CREATE_TABLE= "CREATE TABLE "+TABLE_NAME+
            " ("+KEY_ID+" integer primary key autoincrement," +
            KEY_NAME +" text not null, "+KEY_TENLop+" text not null)";
    ...
    public long addContact(Contact contact) {
        ...
        contentValues.put(KEY_TENLop, contact.getTenLop());
    ...
    public List<Contact> getAllContact() {
        ...
        cursor.moveToFirst();
            ...
            while(cursor.moveToNext()) {
                ...
                contact.setTenLop(cursor.getString(2));
    ...
    public void updateContact(Contact contact) {
        myDB = this.getWritableDatabase();
        String sql = "UPDATE "+TABLE_NAME+" SET "+KEY_TENLop +" = ? WHERE " +KEY_NAME +" = ?";
        Cursor cursor = myDB.rawQuery(sql,
                new String[]{contact.getTenLop(), contact.getName()});
        cursor.moveToFirst();
    }
